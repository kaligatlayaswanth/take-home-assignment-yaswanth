...
def infer_schema_and_metadata(file_path):
    ...
    for chunk in df_chunks:
        ...
        if len(df_list) * chunk_size >= 10000:  # Limit to ~10k rows for analysis
            break
    ...
    for col in df.columns:
        ...
        # Numerical columns: outliers and skewness
    ...
    # Pairwise correlations (numerical columns only)
...
def detect_outliers(series):
    ...
    return outliers[:10]  # Limit to first 10 for brevity